...
/**
 * Like the Sprite class, but can have multiple sprites to handle for
 * animations.
 */
public class SpriteAnimation {
     ...
     * @param indexStart
     *            SpriteSheet index of the frame where animation starts <b>index
     *            from 0</b>.
     * @param indexFinish
     *            SpriteSheet index of the frame where animation ends.
     */
