...
public class Sprite {
    ...
    /**
     * Get sprite using the grid index <b>(starting from 0)</b> of a specific
     * width and height.
     * 
     * @param index
     * @param fromSheet
    ...
    /**
     * Get an sprite of a specific width and height and color <b>(using
     * 0x<i>HEX_CODE</i>)</b>.
     * 
     * @param color
     * @param width
    ...
    /**
     * Get an sprite of a specific size and color <b>(using
     * 0x<i>HEX_CODE</i>)</b>.
     * 
     * @param color
     * @param size
