...
import com.devdream.exside.types.DayTime;
...
public class WorldTime {
    ...
    private DayTime currentDayPart;
    ...
    public WorldTime() {
        ...
        currentDayPart = DayTime.MORNING;
    }
    ...
    private void changeDayPart() {
        ...
        case MORNING:
            currentDayPart = DayTime.AFTERNOON;
            break;
        case AFTERNOON:
            currentDayPart = DayTime.EVENING;
            break;
        case EVENING:
            currentDayPart = DayTime.NIGHT;
            break;
        case NIGHT:
            currentDayPart = DayTime.MORNING;
        }
